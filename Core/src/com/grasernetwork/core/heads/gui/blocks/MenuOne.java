...
public class MenuOne extends Menu
{
	public MenuOne(Player player)
	{
		...
		{
			if (head.getCategory().equalsIgnoreCase("BLOCKS 1"))
			{
		...
		this.addMenuItem(new MenuItem(previousPage.setCustomSkull("M2ViZjkwNzQ5NGE5MzVlOTU1YmZjYWRhYjgxYmVhZmI5MGZiOWJlNDljNzAyNmJhOTdkNzk4ZDVmMWEyMyJ9fX0=")), 39);
		...
		this.addMenuItem(new MenuItem(nextPage.setCustomSkull("MWI2ZjFhMjViNmJjMTk5OTQ2NDcyYWVkYjM3MDUyMjU4NGZmNmY0ZTgzMjIxZTU5NDZiZDJlNDFiNWNhMTNiIn19fQ=="))
		{
			...
			public void onClick(Player player, InventoryClickType clickType)
			{
				MenuAPI.openMenu(player, new MenuTwo(player));
			}
		}, 41);
	}
}
